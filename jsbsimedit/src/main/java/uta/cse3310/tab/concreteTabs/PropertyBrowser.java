...
public class PropertyBrowser extends JDialog {
    ...
    private void initPropertyData() {
        ...
        propData = new Object[][] {
            ...
            {"metrics/Sw-sqm", "wing area", "", "", ""},
            {"metrics/bw-ft", "wing span", "", "", ""},
            {"metrics/bw-m", "wing span", "", "", ""},
            {"metrics/charw-ft", "chord bar", "", "", ""},
            {"metrics/charw-m", "chord bar", "", "", ""},
            {"metrics/hv-deg", "wing incidence angle", "", "", ""},
            {"metrics/sh-sqft", "Horizontal Tail Area", "", "", ""},
            {"metrics/sh-sqm", "horizontal tail area", "", "", ""},
            {"metrics/h-ft", "horizontal tail arm", "", "", ""},
            {"metrics/h-m", "horizontal tail arm", "", "", ""},
            {"metrics/h-norm", "horizontal tail arm", "", "", ""},
            {"metrics/vbarh-norm", "H. Tail Volume", "", "", ""},
            {"metrics/Sv-sqft", "vertical tail area", "", "", ""}
        };
    }
