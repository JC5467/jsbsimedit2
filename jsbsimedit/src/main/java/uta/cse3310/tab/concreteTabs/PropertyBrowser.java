...
public class PropertyBrowser extends JDialog {
    ...
    private void initPropertyData() {
        ...
        propData = new Object[][] {
            ...
            {"atmosphere/T-R", "aero temperature", "DEG", "RO", "the temperature in degrees Rankine"},
            {"atmosphere/T-C", "aero temperature", "DEG", "RO", "the temperature in degrees Celsius"},
            {"atmosphere/T-K", "aero temperature", "DEG", "RO", "the temperature in degrees Kelvin"},
            {"atmosphere/T-sl-R", "temperature at sea level", "DEG", "RO", "sea level temperature in degrees Rankine"},
            {"atmosphere/T-sl-C", "temperature at sea level", "DEG", "RO", "sea level temperature in degrees Celsius"},
            {"atmosphere/T-sl-K", "aero temperature at sea level", "DEG", "RO", "sea level temperature in degrees Kelvin"},
            {"atmosphere/theta-norm", "aero temperature", "NORM", "RO", "the ratio of at-altitude temperature over the sea level value"},
            {"atmosphere/rho-slugs_ft3", "aero density", "SLUGS/FT^3", "RO", ""},
            {"atmosphere/rho-kg_m3", "aero density", "KG/M^3", "RO", ""},
            {"atmosphere/rho-sl-slg_ft3", "aero density at sea level", "SLUGS/FT^3", "RO", ""},
            {"atmosphere/rho-sl-kg_m3", "aero density at sea level", "KG/M^3", "RO", ""},
            {"atmosphere/sigma-norm", "aero density", "norm", "RO", "the ratio of at-altitude density over the sea level value"},
            {"atmosphere/P-psf", "aero density at sea level", "PSF", "RO", ""},
            {"atmosphere/P-pa", "aero pressure", "Pa", "RO", ""},
            {"atmosphere/P-sl-psf", "aero pressure", "PSF", "RO", ""},
            {"atmosphere/P-sl-pa", "aero pressure at sea level", "Pa", "RO", ""},
            {"atmosphere/delta-norm", "aero pressure at sea level", "norm", "RO", "the ratio of at-altitude pressure over the sea level value"},
            {"atmosphere/a-fps", "aero pressure", "FT/SEC", "RO", ""},
            {"atmosphere/a-mps", "sound speed", "M/SEC", "RO", ""},
            {"atmosphere/a-sl-fps", "sound speed", "FPS", "RO", ""},
            {"atmosphere/a-sl-mps", "speed of sound at sea level", "MPS", "RO", ""},
            {"atmosphere/a-norm", "sound speed at sea level", "norm", "RO", "the ratio of at-altitude sound speed over the sea level value"},
            {"atmosphere/psiw-rad", "sound speed", "RAD", "RO", "0 <= psiw < 2*pi"},
            {"atmosphere/density-altitude", "wind direction", "FT", "RO", ""},
            {"atmosphere/density-altitude-m", "density altitude in feet", "M", "RO", ""},
            {"atmosphere/p-turb-rad_sec", "density altitude in meters", "RAD/SEC", "RW", "aero turbulence moment along the X axis"},
            {"atmosphere/d-turb-rad_sec", "aero turbulence moment along the X axis", "RAD/SEC", "RW", "aero turbulence moment in the body frame"},
            {"atmosphere/r-turb-rad_sec", "aero turbulence moment along the Y axis", "RAD/SEC", "RW", "aero turbulence moment in the body frame"},
            {"atmosphere/n-turb-fps", "aero turbulence moment along the Z axis", "FT/SEC", "RW", "aero turbulence force for the north axis"},
            {"atmosphere/n-turb-mps", "aero turbulence force for the north axis", "M/SEC", "RW", "aero turbulence force in the local frame"},
